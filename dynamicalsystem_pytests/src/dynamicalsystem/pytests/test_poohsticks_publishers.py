...
def test_bluesky(environment_variables):
    from dynamicalsystem.poohsticks.publishers import create_publisher
...
def test_get_watermarks(environment_variables):
    from dynamicalsystem.poohsticks.watermarks import watermarks
